                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" id="time" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
                                   class="Wdate form-control" style="height:auto" required message="直播时间"/>
            ...
            <div class="bootstrap-admin-panel-content" id="guest-panel-id">
                ...
                <div id='guest-info'>
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="input-group">
                                <img src="/assets/images/head.png" id="img1" width="44px" height="44px"/>
                            </div>
                            <!-- /input-group -->
                        </div>
                        <div class="col-md-1">
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <div class="input-group">
                            <button type="button" class="btn btn-info"
                                    onclick="BroadcastManager.createNewPresenter()"/>
                            新增主持人
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <button id="send" type="button" class="btn btn-info"
                            onclick="BroadcastManager.saveBroadcast()">提交
                    </button>
                </div>
                <div class="col-md-1">
                    <button type="button" class="btn btn-info"
