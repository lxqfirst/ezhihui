...
ElementsRenderer = (function() {
  ...
  ElementsRenderer.prototype.createNodeLi = function(node) {
    ...
    escaped_parantId = this.escapeIfNecessary(node.parantId);
    escaped_parantName = this.escapeIfNecessary(node.parantName);
    li = document.createElement('li');
    li.className = class_string;
    div = document.createElement('div');
    div.className = "jqtree-element jqtree_common makerdiv";
    div.setAttribute("nodeId", escaped_nodeId);
    div.setAttribute("parantId", escaped_parantId);
    div.setAttribute("parantName", escaped_parantName);
